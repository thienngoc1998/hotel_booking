    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 padding-right-30">
            ...
            <div class="dashboard-list-box margin-top-0">
                ...
                <h4 class="gray">Visitor Reviews</h4>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="comment-content"><div class="arrow-comment"></div>
                                            <div class="comment-by">{{$review->user->name}}<div class="comment-by-listing" style="padding-left: 5px;">on <a href="#" style="padding-left: 10px;">{{$review->room->name}}</a></div> <span class="date">{{$review->created_at->format('d/m/Y')}}</span>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#modalDelete"  data-delete-url="{{route('admin.block-review', $review->id)}}" class="rate-review popup-with-zoom-anim" style="background-color: red;"><i class="sl sl-icon-action-undo"></i> Block </a>
                                         @endif

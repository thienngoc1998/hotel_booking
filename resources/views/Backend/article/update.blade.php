                    ...
                    <div class="dashboard-list-box-static">
                        ...
                        <!-- Avatar -->
                            <div class="edit-profile-photo">
                                <img   :src="url? url :'upload/images/article/{{$article->img}}'" alt="admin" class="img-circle">
                            ...
                            <div class="my-profile">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="{{$article->title}}" name="name" >
                                </div>
                                <div class="form-group">
                                    <label > Mô tả </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="demo" class="ckeditor" name="content_article">{{$article->content}}</textarea>
                                </div>
